...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của toi là: " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim toi như vậy là vì';
document.querySelector('.Description .modal-body').innerHTML = 'Dũng được ở đây để nói ra chính bản thân Dũng';
